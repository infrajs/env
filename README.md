...
Каждому набору параметров в окружении даётся какое-то сокращённое имя. 
Например, окружение blabla может содержать в себе информацию и о всех параметрах.
...
Нужно определить функцию проверки параметра устанавливаемого пользователем
Если новое значение проверку не проходит текущее значение не меняется.
